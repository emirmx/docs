...
{{< figure src="/attachments/refguide10/modeling/menus/view-menu/data-hub-pane/filter-icon.png" alt="Filter Icon"   width="300"  class="no-border" >}}
...
* **Update icon** is a blue arrow icon that indicates that there is another version of the consumed service available in the Catalog. Click to update the service that is consumed in the app to the contract that is now available:
    ...
    {{< figure src="/attachments/refguide10/modeling/menus/view-menu/data-hub-pane/update-available.png" alt="Integration pane update" class="no-border" >}}
...
* **Information icon** allows you to view further details for the service and a link to go directly to the [Service Details](/catalog/manage/search/#search-details) screen in the Catalog:
    ...
    {{< figure src="/attachments/refguide10/modeling/menus/view-menu/data-hub-pane/integration-pane-info.png" alt="Integration pane Information" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/menus/view-menu/data-hub-pane/expand-service-list.png" alt="Integration pane Information" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/menus/view-menu/data-hub-pane/multiple-associations.png" alt="multiple associations" class="no-border" >}}
