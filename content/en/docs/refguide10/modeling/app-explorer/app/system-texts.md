...
{{% alert color="info" %}}
In Studio Pro 10.14.0, the web version of the system texts editor was released as an [experimental](/releasenotes/release-status/) feature. You can enable it via **Preferences** > **New Features**. 
