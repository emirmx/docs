...
{{% alert color="info" %}}
In your app settings you can [change the default](/refguide10/app-settings/#miscellaneous) for all new associations. Existing associations will not be affected. Please note that some associations managed in the System module will be affected even if you haven't created new associations.
{{% /alert %}}
