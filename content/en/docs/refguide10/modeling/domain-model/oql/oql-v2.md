...
This is because view entities, like any other entity type, do not imply order of the results. See [Sorting of view entity results](/refguide10/view-entities/#sorting) for more details.
