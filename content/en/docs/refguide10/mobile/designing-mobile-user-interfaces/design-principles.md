...
### Creating App Designs Using a UI Kit
...
### Translating the UI Kit to Mendix Theme and Components
...
#### Setting Up Main Theme Settings
...
#### Configuring Design Properties {#configure-design-props}
...
#### Creating Building Blocks for Common UI Structures
...
#### Creating Page Templates for Common Page Structures
...
### Implementing Your UI Using Theme and Content
...
### Implementing App or Use-Case Specific Styling
...
### Using Design Properties as Often as Possible
...
### Planning to Reuse as Much as Possible
...
### Never Changing Something in the Core Folder
...
### Favoring Design Properties Over Including Properties
