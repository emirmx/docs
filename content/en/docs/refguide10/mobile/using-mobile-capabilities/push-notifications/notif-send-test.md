...
url: /refguide10/mobile/using-mobile-capabilities/push-notifications/notif-send-test/
weight: 80
...
After [configuring the Push Notifications module](/refguide10/mobile/using-mobile-capabilities/push-notifications/notif-config-push/) and [implementing push notifications in your native app](/refguide10/mobile/using-mobile-capabilities/push-notifications/notif-implement-native/#build-native-app) or your [progressive web app](/refguide10/mobile/using-mobile-capabilities/push-notifications/notif-implement-pwa/) it is now time to send your first test push notification.
