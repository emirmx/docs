...
1. Add a new microflow *ACT_Language_ChangeUserLangRuntime* to your **ChangeLanguage** module and configure it as such:
    ...
    1. Retrieve the language that was selected by the user on the app:
        ...
        1. Your microflow should look like this:
            ...
            {{< figure src="/attachments/refguide10/mobile/native-mobile/native-language-change/microflow-retrieve-object.png"  alt="microflow retrieve object" width= "450" class="no-border" >}}
    ...
    1. To set the selected language, you need to change the language for the current user: 
        ...
        1. Your microflow should look like this:
            ...
            {{< figure src="/attachments/refguide10/mobile/native-mobile/native-language-change/microflow-language-change.png"  alt="microflow language change"  width= "500" class="no-border" >}}
...
1. Your nanoflow should look like this:
    ...
    {{< figure src="/attachments/refguide10/mobile/native-mobile/native-language-change/nanoflow-language-change.png"  alt="nanoflow language change" width= "500" class="no-border" >}}
...
1. To change the language, do the following:
    ...
    1. You should be able to see the title in the **Dutch** language:
        ...
        {{< figure src="/attachments/refguide10/mobile/native-mobile/native-language-change/device-language-overview-nl.png"  alt="language overview dutch" width= "250" class="no-border" >}}
