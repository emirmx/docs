...
1. Create a microflow to trigger the incremental synchronization:
    ...
    {{< figure src="/attachments/refguide10/mobile/best-practices/incremental-synchronization-1.png" alt="Microflow that synchronizes all product objects changed after the last synchronization date" >}}
...
1. Create a nanoflow to initialize the SyncHelper:
    ...
    {{< figure src="/attachments/refguide10/mobile/best-practices/incremental-synchronization-2.png" alt="Nanoflow that initializes the SyncHelper object" >}}
...
1. Create a nanoflow to trigger the incremental synchronization from the mobile device:
    ...
    {{< figure src="/attachments/refguide10/mobile/best-practices/incremental-synchronization-3.png" alt="Nanoflow that triggers the synchronization microflow" >}}
