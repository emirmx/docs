...
{{< figure src="/attachments/refguide10/mobile/progressive-web-app/view-menu.png" alt="View menu" class="no-border" >}}
...
1. Open the developer tools by pressing <kbd>F12</kbd>: 
    ...
    {{< figure src="/attachments/refguide10/mobile/progressive-web-app/pwa-cache.png" alt="Full PWA Cache" width="350" class="no-border" >}}
