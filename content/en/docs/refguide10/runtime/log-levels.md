...
| Critical | {{< figure src="/attachments/refguide10/runtime/mendix-client/log-levels/critical.png" class="no-border" >}} | White (text), red (background) | A serious error has occurred, indicating that the application itself may be unable to continue running. |
