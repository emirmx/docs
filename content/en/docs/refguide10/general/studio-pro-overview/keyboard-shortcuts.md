...
| <kbd>Shift</kbd> (in Studio Pro 10.24 and above) | <kbd>Shift</kbd> (in Studio Pro 10.24 and above) | When holding <kbd>Shift</kbd>, connection points are shown while hovering over elements. |
