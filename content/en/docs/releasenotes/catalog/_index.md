...
* We added support to parse relevant metadata from OpenAPI contracts and improved storage, indexing, and discoverability to promote more advanced use cases.
