...
* Fixed an issue where activity was not logged when deployments were failing through API. (Tickets 266864, #267935)
* Fixed the issue with accessing through Mendix SSO after app was deployed (#271622)
