...
| Maia: Plan - gathering requirements with AI, bridging plan to build               | Private Beta: Mx 11.6  |
...
| Capability or Feature | Expected Release |
|-----------------------|------------------|
| Studio Pro Enhancements | Included in monthly releases: see release blogs |
...
| Menditect UI testing | Public beta: Q2 2025 / General Availability: H2 2025 |
...
| Stream data events to the event broker and from there to data lake for analytics | Public beta: Mx 11.6 |
| OpenType and optional parameters support for OData actions | General Availability: Mx 11.6 |
...
| Marketplace Improved Component management: · Release of Security Fixes · Component Deprecation | General Availability: Mx 11.6 |
...
| Self-Service Provisioning & Deprovisioning of environments | Public beta: Mx 11.0 |
...
| Pipelines for Mendix on Azure, and Mendix on Kubernetes | General Availability: Mx 11.2 |
...
| Mendix Cloud - Self Service App Upgrades and Cloud Resource Pack Recommender | Public beta: Mx 11.9 |
