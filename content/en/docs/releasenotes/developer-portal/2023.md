...
* You can now use a [Personal Access Token](/portal/user-settings/#pat) to access SVN repositories in [Team Server](/developerportal/repository/team-server/) without using your personal Mendix credentials.
