...
- We fixed an issue in the published OData service editor in Studio Pro where showing the list of published enumerations would result in an unexpected exception.
- Install the dotnet runtime x64 on Arm64 computers, since the Console tools still requires the x64 in this Studio Pro version.
...
- We have upgraded the Netty dependency to 4.1.118. (Ticket 242071)
...
For more information, see [Consumed REST Service (Beta)](/refguide/consumed-rest-service/).
