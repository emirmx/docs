...
* We updated the [widget conversions](/refguide10/mendix-client/react/#supported-widgets) to a combo box to include the read-only style of a drop-down, a reference selector and an input reference set selector.
