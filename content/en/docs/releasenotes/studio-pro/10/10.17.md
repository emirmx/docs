...
We added Japanese, Chinese, Korean, and German translations of the Studio Pro interface as a [beta](/releasenotes/beta-features/) feature. This means you can work more easily in your own language. The setting can be found in the [Work environment](/refguide10/preferences-dialog/#work-environment-tab) tab of the Preferences dialog.
