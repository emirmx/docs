...
- We fixed a conversion when upgrading apps from 9.24 for arguments of **Show a page**, **Call a microflow**, or **Call a nanoflow** [event actions](https://docs.mendix.com/refguide/on-click-event/#actions) where parameter mappings would change to a different selection variable on the same page. (Ticket 253494)
