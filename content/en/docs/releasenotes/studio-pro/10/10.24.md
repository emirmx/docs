...
{{% alert color="warning" %}}
We have decided to retract version 10.24.7 due to an issue in database schema migration.  Customers are advised not to deploy applications with this version and upgrade to 10.24.8 or later.
{{% /alert %}}
