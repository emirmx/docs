...
* We improved Maia for Pages to support the [Custom Charts](/appstore/widgets/charts/), [Data Grid 2](/appstore/modules/data-grid-2/), [Image](/appstore/widgets/image/), and [Combo Box](/appstore/widgets/combobox/) widgets, provided they are already installed in Studio Pro.
