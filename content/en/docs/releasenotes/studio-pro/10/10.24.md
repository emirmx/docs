...
{{% alert color="warning" %}}
We have retracted version 10.24.7 due to an issue in database schema migration. We advise customers not to deploy applications with this version, and to upgrade their apps to versions 10.24.8 and above.
{{% /alert %}}
