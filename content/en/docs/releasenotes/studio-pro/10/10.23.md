...
* We fixed an issue where the edited value was not saved in a dialog when the cell lost focus (for example, when you clicked a cell to edit value, edited it, and then clicked an arrow button to expand a value). 
