...
* <a id="fix-installer-certification"></a> We fixed a known issue where the previous installer was not properly digitally signed, which could trigger security warnings from Windows or Microsoft Edge during download and installation. We have fixed this issue.
...
- We made several improvements to the [Security Overview](/refguide/security-overview/), 
...
* The installer for Studio Pro 10.21.0 is not properly signed with the official Mendix code signing certificate. Because of this, Windows/Edge may show warnings or errors when downloading and/or installing this version (depending on your Windows Smart App Control/SmartScreen settings). This issue will be resolved in Studio Pro 10.21.1.
  * Fixed in [10.21.1](#fix-workflow-instances)
