...
You can now define [variables](refguide/page-properties/#variables) for pages and snippets. Once created, variables can be used similarly to attributes on widgets: allowing users to view and edit their values. Variables can also be passed to microflows and nanoflows as parameters, or used in expressions including expressions for conditional visibility and editability.
