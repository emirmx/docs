...
* We fixed an issue that was causing a retriggering of mechanism handling file line endings alignment, because of incorrect git configuration setting being read.
