...
* We fixed the case where the size of the offline database was not reduced enough after a sign-out operation. (Ticket 247029)
* We fixed an issue where Safari extensions could break the Dojo client. (Ticket 246247)
