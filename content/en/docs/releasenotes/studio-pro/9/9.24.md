...
- We fixed an issue where updating the metadata of a consumed OData service where one of the consumed entities did not exist anymore would show an exception.
