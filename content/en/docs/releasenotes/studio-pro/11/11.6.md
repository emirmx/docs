...
* Fixed an issue where the Microsoft Defender exclusion utility failed to run
...
* We have fixed an issue where exporting a Portable App Package failed because file copy operations were performed outside the default file-system scope.
...
* Fixed an issue that caused the History pane to crash.
