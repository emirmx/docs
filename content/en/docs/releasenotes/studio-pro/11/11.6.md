...
{{% alert color="info" %}}For the highlights of this release, see the [Mendix Release 11.6](https://www.mendix.com/blog/release-11-6-zero-downtime-deployments-workflow-advances/) blog post.{{% /alert %}}
