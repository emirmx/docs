...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 11.6](https://www.mendix.com/blog/release-11-6-zero-downtime-deployments-workflow-advances/) blog post.{{% /alert %}}
