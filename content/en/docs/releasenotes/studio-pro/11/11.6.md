...
- The macOS installer now includes the Mendix Version Selector. This enhancement allows macOS Studio Pro users to open applications directly from [Apps](https://sprintr.home.mendix.com/link/myapps), double-click MPR/MPK files to open them, and utilize the `Start from Maia` feature within the Mendix Portal.
