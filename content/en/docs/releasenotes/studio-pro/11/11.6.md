...
- We made the modernized (web) App Explorer the default for all users. It is still possible to fall back the legacy App Explorer by enabling it under **Preferences** > **New Features**.
