...
- We made the modernized (web) App Explorer the default for all users. It's still possible to fall back to the legacy App Explorer in case an issue is found, by enabling it under Preferences -> New Features.
