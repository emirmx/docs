...
* [OQL Statements](/refguide/oql-statements/) are now [Generally Available](/releasenotes/release-status/#ga)
...
* The macOS installer now includes the Mendix Version Selector. This enhancement allows macOS Studio Pro users to open applications directly from the Mendix Portal, double-click MPR/MPK files to open them, and then use the `Start from Maia` feature within the Mendix Portal.
