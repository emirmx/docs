...
We have released workflow interrupting boundary events for general availability (GA). With this new type of boundary event, the workflow can interrupt modeled flows when the timer has expired and start a alternate flow.
