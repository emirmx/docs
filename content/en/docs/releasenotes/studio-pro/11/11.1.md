...
- We modestly improved the memory consumption of object attributes.
...
- The Chinese, Korean, and Japanese versions of the Studio Pro UI are now in general availability (GA). Please see [documentation](/refguide/preferences-dialog/#language) for more information.
