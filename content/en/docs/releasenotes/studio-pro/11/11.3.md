...
- We fixed a rare issue where an error popup could appear if a user attempted a version control operation while Git optimization was running for an extended period (Ticket 246741).
...
- We fixed an issue where combo box widgets failed to render when the **Store** value is configured with a page or snippet variable. (Ticket 256493)
