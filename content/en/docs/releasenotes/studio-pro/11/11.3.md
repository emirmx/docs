...
* We fixed an issue where doing a hot reload while using the React client would lead to the deployment spinner spinning for ever in some projects. (Tickets 257026, 257859)
