...
* **Mendix on Kubernetes** — Select this option for apps deployed to Kubernetes using the Mendix Operator. Refer to [Private Cloud](/developerportal/deploy/private-cloud/) for more information.
