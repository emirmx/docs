...
url: /apidocs-mxsdk/apidocs/extensibility-api/csharp/create-microflows-for-calculations/
weight: 8
---
...
1. Open the project that you previously created when you [created a menu extension](/apidocs-mxsdk/apidocs/extensibility-api/csharp/create-menu-extension/).
