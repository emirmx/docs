...
url: /apidocs-mxsdk/apidocs/csharp-extensibility-api-9/create-dockable-pane-extension/
weight: 5
---

## Introduction

This how-to describes how you can add a custom dockable web pane window to Studio Pro. Before you start this how-to, it is recommended to [Create a Menu Extension Using C#](/apidocs-mxsdk/apidocs/csharp-extensibility-api-9/create-menu-extension/) first.
