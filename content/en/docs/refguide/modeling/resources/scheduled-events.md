...
Although you can choose **Server** time rather than **UTC** time, make sure that your server time is set as you expect. Many servers are set to run on UTC to avoid issues when working across timezones.
