...
1. Deploy the application, upload [Customers.xml](/attachments/refguide/modeling/integration/mapping-documents/importing-xml-documents/18581651.xml), and trigger the import microflow.
