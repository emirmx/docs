...
| [Document Templates](/refguide/document-templates/) | **Deprecated in 10.24** Document Templates were used to design templates for exporting documents based on application data. |
