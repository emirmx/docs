...
{{% alert color="warning" %}}
The modernized access rule editor was made generally available in Studio Pro version 10.20.0, replacing the old editor.
...
{{% alert color="warning" %}}
The old editor is deprecated from 10.20.0 and will be removed in 11.0.0, in the meantime it can still be used by disabling the modern editor in the [Preferences Dialog](/refguide/preferences-dialog/#new-features).
{{% /alert %}}
