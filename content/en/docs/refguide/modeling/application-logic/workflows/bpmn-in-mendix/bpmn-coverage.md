...
* 🟢 Workflow Native — Directly available as a dedicated element in the Workflow Editor — zero extra effort
...
| Element | Support Level | How |
|---|---|---|
| Pool | 🟡 Composable | The workflow itself acts as the process boundary — one workflow equals one pool. Not visible as a canvas element, but the construct is supported. |
| Lane | 🟡 Composable | Use [User Task](/refguide/user-task/) assignments with Roles and Workflow Groups to define who is responsible for each step. Not visible as a canvas element, but the construct is supported. |
...
| Intermediate Catch | 🔵 Planned | As Notification Event, use [Wait for Notification](/refguide/wait-for-notification/) activity as alternative.|
...
| Intermediate Throw | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to send the message and continue the flow. |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to send the message before the process completes. |
...
|---|---|---|
| Start | N/A | N/A |
| Event Subprocess (Interrupting) | 🟡 Composable | Use an [Interrupting Notification Event Subprocess Start](/refguide/workflow-event-sub-processes/#triggers-and-notifications) to catch the event, and use a microflow to handle the error logic and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the error occurs. |
| Event Subprocess (Non-Interrupting) | N/A | N/A |
| Intermediate Catch | N/A | N/A |
| Intermediate Boundary (Interrupting) | 🔵 Planned | Use an *Interrupting Notification Event* (Planned) to catch the event, and use a microflow to handle the error logic and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the error occurs. |
| Intermediate Boundary (Non-Interrupting) | N/A | N/A |
| Intermediate Throw | N/A | N/A |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the error before the process completes. |
...
| Intermediate Catch | 🟡 Composable | Use a [Wait for Notification](/refguide/wait-for-notification/) to catch the event, and use a microflow with multiple [Notify Workflow](/refguide/notify-workflow/) activities to deliver the signal to all waiting instances. |
...
| Intermediate Throw | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing multiple [Notify Workflow](/refguide/notify-workflow/) activities to deliver the signal to all waiting instances. |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing multiple [Notify Workflow](/refguide/notify-workflow/) activities to deliver the signal to all waiting instances before the process completes. |
...
| Intermediate Boundary (Interrupting) | 🔵 Planned | Use an *Interrupting Notification Event* (Planned) to catch the event, and use a microflow to evaluate or create the condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the condition is met. |
| Intermediate Boundary (Non-Interrupting) | 🔵 Planned | Use a *Non-Interrupting Notification Event* (Planned) to catch the event, and use a microflow to evaluate or create the condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the condition is met. |
| Intermediate Throw | N/A | N/A |
| End | N/A | N/A |
...
| Event Subprocess (Non-Interrupting) | 🟡 Composable | Use a [Non-Interrupting Notification Event Subprocess Start](/refguide/workflow-event-sub-processes/#triggers-and-notifications) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the escalation needs to happen. |
| Intermediate Catch | N/A | N/A |
| Intermediate Boundary (Interrupting) | 🔵 Planned | Use an *Interrupting Notification Event* (Planned) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the escalation needs to happen. |
| Intermediate Boundary (Non-Interrupting) | 🔵 Planned | Use a *Non-Interrupting Notification Event* (Planned) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the escalation needs to happen. |
| Intermediate Throw | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the escalation and continue the flow. |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the escalation before the process completes. |
...
| Event Subprocess (Non-Interrupting) | N/A | N/A |
| Intermediate Catch | N/A | N/A |
| Intermediate Boundary (Interrupting) | 🔵 Planned | Use an *Interrupting Notification Event* (Planned) to catch the event, and use a microflow to evaluate the compensation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the compensation needs to happen. |
| Intermediate Boundary (Non-Interrupting) | N/A | N/A |
| Intermediate Throw | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the compensation and redirect the flow to the compensating activity. |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the compensation before the process completes. |
...
| Event Subprocess (Non-Interrupting) | N/A | N/A |
| Intermediate Catch | N/A | N/A |
| Intermediate Boundary (Interrupting) | 🔵 Planned | Use an *Interrupting Notification Event* (Planned) to catch the event, and use a microflow to send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity at the moment the cancellation occurs. |
| Intermediate Boundary (Non-Interrupting) | N/A | N/A |
| Intermediate Throw | N/A | N/A |
| End | 🟡 Composable | Use a [Call Microflow](/refguide/call-microflow/) acting as the throw event, containing a [Notify Workflow](/refguide/notify-workflow/) activity to throw the cancellation before the process completes. |
