...
| Graphic | Name | Description |
| --- | --- | --- |
| {{< figure src="/attachments/refguide/modeling/application-logic/microflows-and-nanoflows/activities/call-nanoflow.png" alt="nanoflow call" link="/refguide/call-nanoflow/" max-width=100% class="no-border" >}} | [Call nanoflow](/refguide/call-nanoflow/) (nanoflows only) | Calls another nanoflow. Arguments can be passed to the nanoflow and the result can be stored in a variable. |
...
| {{< figure src="/attachments/refguide/modeling/application-logic/microflows-and-nanoflows/activities/workflow-call.png" link="/refguide/call-workflow/" max-width=100% class="no-border" >}} | [Call workflow](/refguide/call-workflow/) | Triggers the selected workflow. |
