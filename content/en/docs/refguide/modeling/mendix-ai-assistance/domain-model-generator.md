...
Domain Model Generator is enabled by default.
...
It can generate an attribute of type Enumeration if there is an existing enumeration in the module to refer to.
