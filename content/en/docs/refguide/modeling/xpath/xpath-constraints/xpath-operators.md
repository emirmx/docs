...
In Studio Pro, mathematical operators can be used in XPath constraints that are defined in the model such as the [Retrieve object(s)](/refguide/retrieve/) microflow activity or access rule [constraints](/refguide/access-rules/#xpath-constraints).
