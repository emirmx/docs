...
When the **Show feedback survey periodically** setting is enabled, Studio Pro will periodically display a feedback survey to gather user input on their experience. This helps Mendix improve the product based on user feedback.
