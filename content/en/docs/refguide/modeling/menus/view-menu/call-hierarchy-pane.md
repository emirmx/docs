...
In large Mendix applications, understanding how different parts of the application interact is important for maintainability, debugging and identifing the impact of changes. One of the most important tools for this is the Call Hierarchy tree view, which shows how documents such as Pages, Microflows, Nanoflows and more are interconnected.

This feature helps developers understands dependencies and app connections. For example, What microflows are triggered from this page? Which pages call this nanoflow? If I change this microflow, what will be affected?
...
{{< figure src="/attachments/refguide/modeling/menus/view-menu/call-hierarchy-pane/call-hierarchy.png" alt="Call Hierarchy Pane" class="no-border" >}}
...
When you select **Show call hierarchy** for a document, It is analyzed to get its interactions with other documents.

- For **Incomung calls**, we support showing the call hierarchy for most common identifiable document types, including pages, microflows nanoflows, JS actions, Java actions, and more. 
- For **Outgoing calls**, we support showing the call hierarchy for pages, microflows, nanoflows and rules.
