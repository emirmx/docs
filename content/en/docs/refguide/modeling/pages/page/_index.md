...
{{% alert color="info" %}}
In Studio Pro 10.21 and above, you can use Maia for Pages, an AI-powered tool, to create pages by providing a description of your requirements and optional images. For more information, see [Maia for Pages](/refguide/page-generator/).
{{% /alert %}}
