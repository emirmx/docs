...
To ensure a reliable experience with Maia, Mendix applies a combination of a fair use policy, the ability to purchase Maia Units, and the ability to configure a custom AI provider of your choice.

When your fair use allocation or purchased Maia Units have been consumed, you receive a notification in Studio Pro indicating that you need to take action before you can use Maia Make again. Your allocation resets at the start of each month. To increase your capacity, you can purchase additional Maia Units. For more information on purchasing Maia Units, see [Increasing Your Maia Usage Capacity](/control-center/maia-resources/increase-maia-units/). 
