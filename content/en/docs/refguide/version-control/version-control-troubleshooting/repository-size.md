...
{{% alert color="info" %}}
In Studio Pro 10.18 MPRv2 was released as [Public Beta](/releasenotes/beta-features/). In Studio Pro 10.21 MPRv2 reached Generally Available (GA) state and is automatically used for new apps.
{{% /alert %}}
...
In Studio Pro 10.18 and above and you can manually convert branches to MPRv2. In a future version branch conversion will happen automatically. For more information on the format, see the [MPRv2 Format](#mprv2) section.
