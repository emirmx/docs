...
* The [Deep Link module](https://marketplace.mendix.com/link/component/43) is deprecated and will not receive active support anymore in Mendix 11. The functionality this module offers has been replaced by built-in features of the Mendix Platform like Page URLs and Microflow URLs. See the [migration guide](https://docs.mendix.com/appstore/modules/deep-link/#migrate-page-micro) on how to migrate to these built-in features.
