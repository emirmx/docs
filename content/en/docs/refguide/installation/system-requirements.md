...
* **RAM** – recommended 16GB or more depending on the size of your App and how many Studio Pro instances you want to have open at the same time
...
Studio Pro performance is impacted strongly by the disk performance. Using network storage will likely lead to poor performance. Specifically in virtual desktop environments careful consideration should be given to disk performance.
