...
| <a id="EnableCors" href="#enableCors">EnableCors</a> | When enabled, the runtime will respond to all `OPTIONS` requests. Use this setting in combination with the <a href="#Headers">Headers</a> runtime setting to configure CORS for the entire runtime. | false |
