...
| <a id="MaxRetrieveSize" href="#MaxRetrieveSize">MaxRetrieveSize</a> | The max amount of objects the client is allowed to retrieve in a single XAS request. This limit exists to prevent malicious actors from being able to overload the runtime by requesting enormous amounts of objects in a single request. | 1000 |
