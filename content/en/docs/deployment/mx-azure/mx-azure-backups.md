...
Steps to restore a backup snapshot:
...
- Click **More Options** ({{% icon name="three-dots-menu-horizontal" %}}) > **Download** on the desired backup.
- Click **Start** to request the download.
- After processing completes, use the **Download** button to retrieve the archive.
- Optionally, click **Show URL** to copy the download link.
