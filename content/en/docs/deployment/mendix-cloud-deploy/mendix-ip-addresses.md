...
For the Mendix apps deployed to the Cloud Foundry infrastructure:
* `10.10.128.0/21`
* `10.10.136.0/21`
* `10.10.144.0/21`

For the Mendix apps deployed to the Kubernetes infrastructure:
* `10.11.64.0/18`
* `10.11.128.0/18`
* `10.11.192.0/18`

> To find the Mendix application infrastructure, go to [Apps](https://sprintr.home.mendix.com/link/myapps) and check the Infrastructure label on your environment. The label will contain either Cloud Foundry or Kubernetes.
