...
* **Status**
   * {{% icon name="checkmark-circle-filled" color="green" %}} – The application in this environment is running without any alerts.
    ...
    * {{% icon name="remove-circle-filled" color="red" %}} – The application in this environment is running, but has critical alerts, which might make it unstable and not usable anymore. Check the alerts page or logs for more information.
