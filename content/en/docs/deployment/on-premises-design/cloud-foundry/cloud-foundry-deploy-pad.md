...
To deploy your app to an on-premises Cloud Foundry configuration using [Portable App Distribution](/developerportal/deploy/portable-apps-distribution/), ensure that you fulfill the following prerequisites:
...
2. Save the [Portable App Distribution .zip file](/developerportal/deploy/portable-apps-distribution/) to an accessible location.
