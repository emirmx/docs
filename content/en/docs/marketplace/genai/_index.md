...
| [MCP Client](https://marketplace.mendix.com/link/component/244893) | Access tools and prompts available via MCP inside of your Mendix app and add them to LLM requests. | Connector Module | 10.24 |
| [MCP Server](https://marketplace.mendix.com/link/component/240380) | Make your Mendix business logic available to any agent in your enterprise landscape with the Mendix MCP Server module. Expose reusable prompts including the ability to use prompt parameters. List and run actions implemented in the application as tool. | Module | 10.24 |
