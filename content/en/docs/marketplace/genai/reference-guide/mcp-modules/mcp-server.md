...
The MCP Server be publicly accessed unless you specify [path-based restrictions](developerportal/deploy/environments-details/#path-based-restrictions) on the endpoint when running on Mendix Cloud or on your own infrastructure.
