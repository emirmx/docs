...
1. Set up the following information in the **User Provisioning** tab:
    ...
    * **User Type** – this allows you to configure end-users of your application as internal or external. It is created upon the creation of the user and updated each time the user logs in. For more information, see [Implementing User Metering](/developerportal/deploy/implementing-user-metering/).
