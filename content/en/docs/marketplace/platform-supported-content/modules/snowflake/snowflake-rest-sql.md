...
* GenAI Commons module ver. 3.x from the [GenAI For Mendix](https://marketplace.mendix.com/link/component/227931) bundle – Required for the Snowflake REST Connector version 2.0.0. This module is a required dependency for the Snowflake Cortex Analyst.
