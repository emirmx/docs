...
* SCIM Module supports to delete all users provisioned by an IdP using  **Delete All Users** button in the IdP Configuration . After you delete the all associated users, you can delete the IdP using **Delete** button.
